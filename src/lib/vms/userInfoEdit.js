...
define("vms/userInfoEdit", ['urls', 'userCenter', 'jquery', 'eventproxy', 'mmState', 'dialog', 'vms/main', 'mmState', 'mmHistory'], function(urls, userCenter, $, EP){
    ...
    avalon.state('userInfoEdit',{
        ...
        onEnter: function() {
            ...
            if(!avalon.vmodels['userInfoEdit']){
                avalon.define({
                    $id: "userInfoEdit",
                    data: {},
                    academyHash: [],
